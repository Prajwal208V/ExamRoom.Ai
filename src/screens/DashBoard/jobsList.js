            ...
            <View style={{flexDirection: 'row'}}>
              <Text
                style={{
                  fontSize: 10,
                  fontWeight: '400',
                }}>{`${item?.job_city}, ${item?.job_state}, ${item?.job_country}`}</Text>
              <Text
                style={{
                  fontSize: 10,
                  fontWeight: '400',
        ...
        <IrisModal
          ...
          <View style={styles.Modalcontainer}>
            <ScrollView style={{paddingHorizontal: 10, width: '100%'}}>
                ...
                <View style={{flexDirection: 'column', paddingLeft: 8}}>
                  ...
                  <Text
                    style={{
                      fontSize: 11,
                      fontWeight: '400',
                    }}>{`${particularJob?.job_city}, ${particularJob?.job_state}, ${particularJob?.job_country}`}</Text>
                </View>
              </View>
              <View style={{marginLeft: 0, marginTop: 10}}>
                <Text
                  style={{fontWeight: '600', fontSize: 12, paddingVertical: 4}}>
                  Job posted :
              ...
              />
              <Text style={{fontSize: 15, fontWeight: '500', marginBottom: 5}}>
                Job Description
              </Text>
